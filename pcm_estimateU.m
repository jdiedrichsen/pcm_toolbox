function [U,G,iV,iVr] = pcm_estimateU(theta,Y,M,Z,X,varargin);
% function [U,G] = pcm_estimateU(theta,Y,M,Z,X,varargin);
...
% OUTPUT:
%      U:     KxP matrix   Negative Log likelihood of all subject's data
