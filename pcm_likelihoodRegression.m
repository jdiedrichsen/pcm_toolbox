function [negLogLike,dnl,d2nl] = pcm_likelihoodRegression(theta,Z,Y,comp,X,varargin);
% function [negLogLike,dnl,d2nl] = pcm_likelihoodIndivid(theta,Z,Y,comp,X,varargin);
